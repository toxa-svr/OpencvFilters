...
ExampleNode::ExampleNode(QGraphicsScene *scene,
                         QMenu *contextMenu,
    ...
    NodeItem(contextMenu, parent, scene, wFlags)
{
    ...
    addPortAndLabel("in0", NodePort::In, NodePort::Left);
    addPortAndLabel("in1", NodePort::Out, NodePort::Left);
    addPortAndLabel("in2", NodePort::In, NodePort::Left);
    addPortAndLabel("in3", NodePort::Out, NodePort::Right);
}



void ExampleNode::setWidget(QWidget *widget) {
    //does this work for all possible wiget types
    NodeItem::setWidget(widget);
    widget->setObjectName("ExampleNode");
}




void ExampleNode::addPortAndLabel(QString name,
                          NodePort::PortType t,
    ...
    addPort(new NodePort(this, scene(), l, t, align, false));
}
